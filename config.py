...
class BaseOptions():
    ...
    def __init__(self):
        ...
        parser.add_argument('--outside',type=bool,default=True,help='palm or back of MANO mean joints xyz.')   
        ...
        parser.add_argument('--feature',type=str,default='x2', help='EncoderTransformer feature extract level, x2 or x3, [x2, x3]')
        ...
        parser.add_argument('--mask_rate',type=float,default=0.0,help='transformer feature mask ratio')
        parser.add_argument('--pos_embed',type=bool,default=True,help='is Positional encoding available')
        
        # pose length reg. 2021.02.23 week8 星期二
        parser.add_argument('--pl_reg',type=bool,default=False,help='pose length regularization')
